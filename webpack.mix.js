 ...
 */
mix.styles([
    'resources/assets/admin/mdb/css/bootstrap.min.css',
    'resources/assets/admin/mdb/css/mdb.min.css',
    'resources/assets/admin/fontawesome/4.5.0/css/font-awesome.min.css',
...
mix.scripts([
        ...
        'resources/assets/admin/mdb/js/bootstrap.min.js',
        'resources/assets/admin/mdb/js/mdb.min.js',
...
mix.copy('resources/assets/admin/mdb/font', 'public/fonts');
